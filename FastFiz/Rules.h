...
namespace Pool {
  ...
  class GameState {
    public:
      ...
      virtual const bool isOpenTable() const {return true;};
      virtual const TurnType getTurnType() const {return _turnType;};
      /** Returns true if current player should shoot solids. 
       * Only meaningful if isOpenTable is false. 
       */
      virtual const bool playingSolids() const {return false;};
      /** Returns true if the current player had the inital break */
      virtual const bool curPlayerStarted() const {return _curPlayerStarted;};
      /** Returns the amount of time left (in seconds) for the current player */
      virtual const double timeLeft() const {return _timeLeft;};
      /** Returns the amount of time left (in seconds) for the other player */
      virtual const double timeLeftOpp() const {return _timeLeftOpp;};
  ...
  class EightBallState : public GameState
  {
    public:
      ...
      // Subclasses should call this, and then output their internals
        ...
        virtual const bool playingSolids() const {return _solids;};
        virtual const bool isOpenTable() const {return _openTable;};
